...
class XPSocialButtons extends StatelessWidget {
      ...
      children: [
        Container(
          decoration: BoxDecoration(
              border: Border.all(color: XPColors.grey),
              borderRadius: BorderRadius.circular(100)),
          child: IconButton(
              onPressed: () => controller.googleSignIn(),
              icon: const Image(
                image: AssetImage(XPImages.google),
                width: XPSizes.iconMd,
                height: XPSizes.iconMd,
              )),
        ),
        ...
        Container(
          ...
          child: IconButton(
              onPressed: () {},
              icon: const Image(
                image: AssetImage(XPImages.facebook),
                width: XPSizes.iconMd,
                height: XPSizes.iconMd,
              )),
        ),
